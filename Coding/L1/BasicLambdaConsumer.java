...
public class BasicLambdaConsumer {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n=== Step 4: Replace anonymous class with lambda expression ===");
        // Step 4: Replace the anonymous class with a lambda expression
        fruits.forEach((String fruit) -> {
            System.out.println(fruit);
        });
        
        // Even more concise lambda (type inference + single statement)
        fruits.forEach(fruit -> System.out.println(fruit));
        
        System.out.println("\n=== Step 5: Replace lambda with method reference ===");
        // Step 5: Replace the lambda with a method reference
        fruits.forEach(System.out::println);
        
        System.out.println("\n=== Step 6: Consumer<String> that prints in uppercase ===");
